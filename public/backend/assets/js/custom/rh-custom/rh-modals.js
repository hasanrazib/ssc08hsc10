...
// marital
var KTModal_jobindustry = function () {
	var submitButton;
	var cancelButton;
	var validator;
	var form;
			...
			form,
			{
				fields: {
					'jobindustry_name': {
						validators: {
							notEmpty: {
								message: 'Job Industry should not be empty.'
							}
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_jobindustry_add');
			...
			form = document.querySelector('#kt_modal_jobindustry_add_form');
			submitButton = document.getElementById('kt_modal_jobindustry_submit');
			cancelButton = document.getElementById('kt_modal_jobindustry_cancel');
...
// property category
var KTModal_propertycategory = function () {
	var submitButton;
	var cancelButton;
	var validator;
	var form;
			...
			form,
			{
				fields: {
					'property_category_name': {
						validators: {
							notEmpty: {
								message: 'Property Category should not be empty.'
							}
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_propertycategory_add');
			...
			form = document.querySelector('#kt_modal_propertycategory_add_form');
			submitButton = document.getElementById('kt_modal_propertycategory_submit');
			cancelButton = document.getElementById('kt_modal_propertycategory_cancel');
