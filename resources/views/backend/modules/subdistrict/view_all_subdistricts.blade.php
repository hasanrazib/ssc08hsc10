    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Sub Districts List</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Sub-Districts" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach($subdistricts as $key => $item)
                            <tr>
                                ...
                                <!--end::Name=-->
                                 <!--begin::Name=-->
                                 <td>
                                    <a href="../../demo1/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $item ['district']['district_name'] }}</a>
                                </td>
                                <!--end::Name=-->
                                 <!--begin::Name=-->
                                 <td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        ...
                                        <a href="{{route('delete.subdistrict', $item->id)}}" id="delete" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
