                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="">
                                            <div class="symbol-label">
                                                <img src="{{ (!empty($item->profile_image))? url($item->profile_image):url('upload/no_image.jpg') }}" alt="Emma Smith" class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                       <a href="{{route('admin.view.single.user', $item->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                        ...
                                        <a href="{{route('admin.delete.single.user', $item->id)}}" id="delete" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
