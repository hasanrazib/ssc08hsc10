        ...
        <div class="container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div class="d-flex align-items-center d-lg-none ms-n3 me-1" title="Show aside menu">
                <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" id="kt_aside_mobile_toggle">
                    <!--begin::Svg WIcon | path: icons/duotune/abstract/abs015.svg-->
...
-->
                        ...
                        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                <img src="{{ (!empty($adminData->profile_image))? url($adminData->profile_image):url('upload/no_image.jpg') }}" alt="user" />
                            </div>
                            <!--begin::Menu-->
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <img alt="Logo" src="{{ (!empty($adminData->profile_image))? url($adminData->profile_image):url('upload/no_image.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Username-->
                                        <div class="d-flex flex-column">
                                            <div class="fw-bolder d-flex align-items-center fs-5">{{$adminData->name}}
                                           </div>
                                            <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{$adminData->email}}</a>
                                        </div>
                                        <!--end::Username-->
                                    </div>
                                </div>
